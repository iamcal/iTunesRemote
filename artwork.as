on run argv
	...
	do shell script ("rm -f " & the_path & "/artwork.png") as text
	do shell script ("cp " & the_path & "/default.png " & the_path & "/artwork.png") as text
	...
	set fixed_file to (the_path & "/artwork_temp" & ext) as text
...
-- end tell
	...
	tell application "Image Events"
		...
		set new_item to (the_path & "/artwork.png") as string
		save this_image in new_item as PNG
		close this_image
	end tell 

	do shell script ("rm " & fixed_file) as text
